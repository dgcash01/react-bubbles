...
Look up a website by typing in a URL, browser connects to a server then requests the web server (the program) for the website that matches the URL, and web server then sends back the requested website.
